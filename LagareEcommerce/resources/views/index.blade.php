        ...
        <div id="top-header">
            <div class="container">
                <ul class="header-links pull-left">
                    <li><a href="#"><i class="fa fa-phone"></i> +032-341-5884</a></li>
                    <li><a href="#"><i class="fa fa-envelope-o"></i> lordleolagare@gmail.com</a></li>
                    <li><a href="#"><i class="fa fa-map-marker"></i> 6015 Lapu-Lapu City</a></li>
                </ul>
                <nav class="navbar navbar-expand-lg navbar-light bg-light"
                    style="min-height: unset !important; margin-bottom: 0;">
                    <div class="container-fluid">
                        <div class="collapse navbar-collapse" id="navbarNav">
                            <ul class="navbar-nav ml-auto">
                                @guest
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('login') }}" style="margin-left: 50rem; color: white">{{ __('Login') }} /&nbsp;</a>
                                </li>
                            ...
                            @else
                                <li class="nav-item dropdown">
                                    <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button"
                                        ...
                                        style="margin-left: 50rem; color: white">
        ...
        <div id="header">
            ...
            <div class="container">
                ...
                <div class="row">
                    <!-- LOGO -->
                    <div class="col-md-3"
                        style="display: flex; justify-content: center; align-items: center; padding-top: 1.25rem">
                        <div class="header-logo">
                            <a href="#" class="logo">
                                {{-- <img src="/assets/img/logo.png" alt=""> --}}
                                <h1 style="color: white;">4L Shop</h1>
                            </a>
                        </div>
                    </div>
                    <!-- /LOGO -->
                    ...
                    <div class="col-md-3 clearfix">
                        <div class="header-ctn">
                            ...
                            <!-- Cart -->
                            <div class="dropdown">
                                <a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true" href="{{ route('order.summary') }}">
